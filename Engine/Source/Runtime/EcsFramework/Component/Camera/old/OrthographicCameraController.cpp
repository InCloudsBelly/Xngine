...
namespace X
{
    ...
    void OrthographicCameraController::OnUpdate(Timestep ts)
    {
        ...
        else if (Input::IsKeyPressed(X_KEY_D))
            mCameraPosition.x += mCameraTranslationSpeed * ts;
        ...
        if (mRotation)
        {
            ...
            else if (Input::IsKeyPressed(X_KEY_E))
                mCameraRotation -= mCameraRotationSpeed * ts;
    ...
    void OrthographicCameraController::OnEvent(Event& e)
    {
        ...
        dispatcher.Dispatch<MouseScrolledEvent>(X_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
        dispatcher.Dispatch<WindowResizeEvent>(X_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
    }
