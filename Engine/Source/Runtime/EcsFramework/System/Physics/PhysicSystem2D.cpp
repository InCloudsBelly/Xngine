...
namespace X
{
	static b2BodyType Rigidbody2DTypeToBox2DBody(Rigidbody2DComponent::BodyType bodyType)
	{
		switch (bodyType)
		{
		case X::Rigidbody2DComponent::BodyType::Static:		return b2_staticBody;
		case X::Rigidbody2DComponent::BodyType::Dynamic:		return b2_dynamicBody;
		case X::Rigidbody2DComponent::BodyType::Kinematic:	return b2_kinematicBody;
		default:													break;
		}
	...
	void PhysicSystem2D::OnRuntimeStart()
	{
	...
	void PhysicSystem2D::OnUpdateRuntime(Timestep ts)
	{
		...
		mPhysicsWorld->Step(ts, velocityIterations, positionIteration);
