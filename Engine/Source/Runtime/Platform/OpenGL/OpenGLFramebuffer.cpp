...
namespace X
{
	...
	namespace Utils
	{
		...
		static GLenum HEngineFBTextureFormatToGL(FramebufferTextureFormat format)
		{
			switch (format)
			{
			case X::FramebufferTextureFormat::None:				break;
			case X::FramebufferTextureFormat::RGBA8:				return GL_RGBA8;
			case X::FramebufferTextureFormat::RED_INTEGER:		return GL_RED_INTEGER;
			case X::FramebufferTextureFormat::DEPTH24STENCIL8:	break;
			default:													break;
			}
	...
	{
		X_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size());
