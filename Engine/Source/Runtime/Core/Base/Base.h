...
// Platform detection using predefined macros
	 ...
	 * and not some other Apple platform */
		...
		#define X_PLATFORmIOS
		#error "IOS is not supported!"
	#elif TARGET_OS_MAC == 1
		#define X_PLATFORmMACOS
  ...
  * it has __linux__ defined */
	...
	#define X_PLATFORmANDROID
	#error "Android is not supported!"
#elif defined(__linux__)
	#define X_PLATFORmLINUX
...
#ifdef X_DEBUG
	#if defined(X_PLATFORmWINDOWS)
		#define X_DEBUGBREAK() __debugbreak()
	#elif defined(X_PLATFORmLINUX)
		#include <signal.h>
...
#define X_XSTRINGIFY_MACRO(x) X_STRINGIFY_MACRO(x)
